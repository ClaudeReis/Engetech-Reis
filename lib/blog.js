...
export const POSTS = [
  ...
  },
  {
    ...
    titleTag: "Por que seu negócio não aparece no Google",
    metaDescription:
      "Seu negócio não aparece no Google? Veja os 5 motivos mais comuns — e o passo a passo pra ser encontrado por quem procura seu serviço na sua região.",
    h1: "Por que seu negócio não aparece no Google (e como resolver)",
    excerpt:
