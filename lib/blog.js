...
export const POSTS = [
  {
    slug: "site-fora-do-ar-causas-comuns",
    titleTag: "Site Fora do Ar: Causas Comuns e Como Evitar",
    metaDescription:
      "Site fora do ar do nada? Veja as causas mais comuns, domínio vencido, hospedagem atrasada, certificado expirado, e como evitar perder cliente por isso.",
    h1: "Site fora do ar: as causas mais comuns e como evitar",
    excerpt:
      "O telefone não toca e ninguém percebe o motivo até checar o site. Veja os motivos mais comuns de um site sair do ar e como evitar cada um deles.",
    keyword: "site fora do ar",
    category: "Manutenção",
    date: "2026-09-16",
    readingTime: "5 min",
    body: [
      {
        type: "p",
        html: "Já falamos aqui <a href=\"/blog/por-que-site-precisa-de-manutencao/\">por que todo site precisa de manutenção</a>, mas vale ir direto num ponto específico, porque é o que mais aparece na prática: site fora do ar do nada, sem aviso, sem ninguém saber o motivo. Na maioria das vezes não é um bug misterioso nem falha de sistema, é uma causa concreta e bem conhecida, que só não foi percebida a tempo. Veja as mais comuns.",
      },
      { type: "h2", text: "Domínio vencido" },
      {
        type: "p",
        html: "O domínio (o endereço do site, tipo seusite.com.br) tem validade e precisa ser renovado todo ano. Quando ninguém renova a tempo, o site sai do ar de uma hora pra outra, mesmo que a hospedagem esteja em dia e tudo mais esteja funcionando normalmente por trás. Se a renovação demora demais, existe até o risco de outra pessoa registrar o mesmo domínio, o que complica ainda mais recuperar o endereço original.",
      },
      { type: "h2", text: "Hospedagem atrasada ou suspensa" },
      {
        type: "p",
        html: "A hospedagem é o serviço que mantém os arquivos do site acessíveis na internet, e ela também depende de pagamento em dia. Quando a fatura atrasa, a maioria dos provedores suspende a conta depois de um prazo, e o site simplesmente para de carregar, sem nenhum aviso prévio pro visitante. É uma das causas mais comuns justamente porque costuma passar despercebida até alguém tentar acessar o site e não conseguir.",
      },
      { type: "h2", text: "Certificado de segurança (SSL) expirado" },
      {
        type: "p",
        html: "O certificado de segurança é o que garante o cadeado ao lado do endereço do site, e ele também vence. Quando isso acontece, o navegador passa a mostrar um aviso grande de \"site não seguro\" antes mesmo de carregar a página, e boa parte de quem chega desiste ali, sem nem tentar continuar. Na prática o site ainda existe, mas fica efetivamente fora do ar pra quem visita.",
      },
      { type: "h2", text: "Mudança feita sem testar antes" },
      {
        type: "p",
        html: "Trocar um texto, subir uma imagem nova ou mexer em alguma configuração parece simples, mas um erro nesse processo, como um arquivo corrompido ou uma configuração errada, pode derrubar o site inteiro. É mais comum em alterações feitas às pressas, sem checar o resultado antes de considerar a tarefa concluída.",
      },
      { type: "h2", text: "Instabilidade do provedor de hospedagem" },
      {
        type: "p",
        html: "Às vezes a causa não está do lado do dono do site: o próprio provedor de hospedagem passa por uma instabilidade, manutenção ou pane, e todos os sites hospedados ali saem do ar juntos por um tempo. Esse tipo de queda foge do controle de quem administra o site, mas ainda assim vale ter alguém acompanhando pra saber que aconteceu e confirmar quando volta.",
      },
      {
        type: "quote",
        text: "Nenhuma dessas causas aparece com aviso prévio. O primeiro sinal costuma ser o cliente que tentou entrar no site, não conseguiu, e foi direto pro concorrente que apareceu do lado.",
      },
      { type: "h2", text: "Como descobrir que o site caiu antes do cliente" },
      {
        type: "p",
        html: "O problema raramente é só o site sair do ar, é ninguém perceber a tempo. Sem alguém de olho, um site pode ficar fora do ar por dias antes que o próprio dono descubra, geralmente porque um cliente comentou ou porque ele mesmo tentou acessar por acaso. Ter um lembrete de renovação de domínio, um alerta de vencimento de certificado e alguém checando o site com regularidade é o que fecha essa brecha antes que ela vire prejuízo.",
      },
      { type: "h2", text: "Como evitar" },
      {
        type: "ul",
        items: [
          "Renovar domínio e hospedagem com antecedência, de preferência com renovação automática ativada.",
          "Acompanhar a validade do certificado de segurança, já que muitos provedores renovam automático, mas nem todos.",
          "Testar qualquer mudança no site antes de considerar a tarefa concluída, mesmo uma alteração pequena.",
          "Ter alguém responsável por checar se o site está no ar com regularidade, não só na hora em que algo já deu errado.",
        ],
      },
      {
        type: "p",
        html: "Isso é justamente o que cobre a <a href=\"/blog/por-que-site-precisa-de-manutencao/\">manutenção de site</a>: alguém cuidando desses detalhes pra que você não precise lembrar de renovação de domínio ou de certificado no meio da rotina do seu negócio. No <a href=\"/site-institucional/\">site institucional</a> da EngeTech Reis, o plano de manutenção parte de R$497 por mês e cobre exatamente esses pontos. Se o seu site já caiu alguma vez sem você saber o motivo, ou se você não tem certeza de quem está cuidando disso hoje, dá pra chamar no WhatsApp pra tirar dúvida sobre o seu caso.",
      },
    ],
    faqs: [
      {
        q: "Qual é a causa mais comum de um site sair do ar?",
        a: "Domínio vencido e hospedagem atrasada são as causas mais comuns, porque dependem de renovação periódica que costuma passar despercebida até o site parar de carregar.",
      },
      {
        q: "Por que meu site mostra aviso de 'não seguro' mesmo estando no ar?",
        a: "Provavelmente o certificado de segurança (SSL) do site venceu. O navegador passa a exibir esse aviso antes mesmo de carregar a página, e boa parte de quem chega desiste ali, então na prática o site fica efetivamente fora do ar pra quem visita.",
      },
      {
        q: "Como sei se meu site caiu sem eu perceber?",
        a: "Sem alguém checando com regularidade, um site pode ficar fora do ar por dias sem que o dono saiba, geralmente até um cliente comentar ou até ele mesmo tentar acessar por acaso. Um serviço de manutenção inclui esse acompanhamento.",
      },
      {
        q: "Site fora do ar por causa do provedor de hospedagem é minha responsabilidade?",
        a: "Não diretamente, esse tipo de queda foge do controle de quem administra o site. Mesmo assim, vale ter alguém acompanhando pra confirmar quando o problema aconteceu e quando o site voltou ao normal.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        html: "O custo de pular a manutenção raramente aparece na hora. Ele aparece semanas ou meses depois, como um domínio perdido bem na época de mais movimento, como um cliente que fecha a aba ao ver o aviso de site inseguro, ou como <a href=\"/blog/site-fora-do-ar-causas-comuns/\">dias inteiros de site fora do ar</a> sem que ninguém tenha notado a tempo. Comparado a isso, o custo mensal de manter tudo funcionando é pequeno, e é justamente o tipo de gasto que evita um prejuízo bem maior lá na frente.",
      },
