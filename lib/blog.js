...
export const POSTS = [
  {
    ...
    titleTag: "Chatbot para Site: Como Funciona",
    metaDescription:
      "Chatbot para site responde visitantes na hora, qualifica quem tem interesse real e manda pro seu WhatsApp. Entenda como funciona e por que vale a pena ter um.",
    h1: "Chatbot no site: como funciona e por que seu negócio precisa de um",
    excerpt:
      "O visitante chega no seu site às 23h com uma dúvida real e some porque ninguém responde. Veja como um chatbot para site resolve isso sem tirar o atendimento humano de você.",
    ...
    body: [
      ...
      { type: "h2", text: "Como funciona por trás dos panos" },
      {
        type: "p",
      ...
      {
        type: "p",
        html: "Se o seu site ou landing page já está no ar, o chatbot entra sem precisar mexer no que já existe. A EngeTech Reis monta o fluxo pro seu tipo de negócio, instala e deixa rodando — você só recebe o lead qualificado no WhatsApp. Dá pra ver os detalhes na página de <a href=\"/chatbot-para-site/\">chatbot para site</a>, e se quiser tirar dúvida antes, é só chamar no WhatsApp.",
      },
    ],
  },
  {
    slug: "site-para-negocio-local-rio-de-janeiro",
    titleTag: "Site para Negócio Local no Rio de Janeiro",
    metaDescription:
      "Site para negócio local no Rio de Janeiro rankeia mais que um site genérico. Entenda por que especificidade de bairro e nicho traz cliente mais qualificado.",
    h1: "Site para negócio local: por que específico rankeia mais que genérico",
    excerpt:
    ...
    keyword: "site para negócio local no rio de janeiro",
    category: "Local",
    date: "2026-07-15",
    readingTime: "6 min",
    body: [
      {
        type: "p",
        html: "Tem um erro que quase todo negócio local comete sem perceber: pedir um site igual ao de qualquer empresa do Brasil, em vez de pedir um site para negócio local no Rio de Janeiro, pensado pro seu bairro e pro seu nicho. Um site bonito, com texto genérico sobre “qualidade” e “compromisso”, que poderia ser de uma clínica em São Paulo, de um eletricista em Salvador ou de uma joalheria em Curitiba. O problema não é a estética — é que esse site entra numa disputa que ele não tem como vencer.",
      },
      ...
      { type: "h2", text: "Um site para negócio local no Rio de Janeiro compete contra muito menos gente" },
      {
        type: "p",
      ...
      {
        type: "quote",
        text: "Genérico compete com o país inteiro. Específico compete só com quem está no seu bairro e no seu nicho — e é aí que dá pra ganhar.",
      },
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        html: "É exatamente esse pacote que a gente entrega na EngeTech Reis: <a href=\"/blog/site-para-negocio-local-rio-de-janeiro/\">sites feitos do zero pra negócios locais no Rio</a>, já com SEO e velocidade desde o primeiro dia. Se quiser entender quanto isso custa, o <a href=\"/blog/quanto-custa-um-site-profissional/\">artigo sobre preço de site</a> abre a faixa real — e se preferir, é só chamar no WhatsApp que a gente olha o seu caso.",
      },
    ],
  },
  {
