...
export const POSTS = [
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Template pronto é sempre mais barato que site sob medida?",
      ...
      {
        q: "Site sob medida demora mais pra ficar pronto?",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        html: "É exatamente esse pacote que a gente entrega na EngeTech Reis: <a href=\"/blog/site-para-negocio-local-rio-de-janeiro/\">sites feitos do zero pra empresas locais no Rio</a>, já com SEO e velocidade desde o primeiro dia. Se quiser entender quanto isso custa, o <a href=\"/blog/quanto-custa-um-site-profissional/\">artigo sobre preço de site</a> abre a faixa real. Se preferir, é só chamar no WhatsApp que a gente olha o seu caso.",
      },
    ],
    faqs: [
      {
