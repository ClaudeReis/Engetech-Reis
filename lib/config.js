...
export const WA_MESSAGES = {
  ...
  servicoChatbot:
    "Olá! Quero um chatbot pro meu site. Vim pela página de chatbot da EngeTech Reis.",
  sobre:
    "Olá, Jonathan! Vi a página Sobre da EngeTech Reis e quero um site que converte.",
};
