...
export const PROJECTS = [
  {
    ...
    size: "featured",
    caso: {
      titleTag: "Site para biomédica esteta na Penha, RJ — Case Adriana Lima",
      metaDescription:
  ...
  },
  {
    ...
    size: "medium",
    caso: {
      titleTag: "Site para empresa de reformas no Rio de Janeiro — Case Colosso",
      metaDescription:
  ...
  },
  {
    ...
    size: "medium",
    caso: {
      titleTag: "Site para eletricista no Rio de Janeiro — Case MCD Soluções Elétricas",
      metaDescription:
  ...
  },
  {
    ...
    caso: {
      titleTag:
        "Landing page para lançamento imobiliário em Campo Grande, RJ — Case Origem West",
      metaDescription:
  ...
  },
  {
    ...
    caso: {
      titleTag:
        "Site para clínica de estética na Vila da Penha, RJ — Case Larissa Nardi",
      metaDescription:
