...
export const SERVICOS = [
  {
    ...
    outrosServicos: ["site-institucional", "chatbot-para-site"],
  },
  {
    ...
    outrosServicos: ["criar-landing-page", "chatbot-para-site"],
  },
  {
    ...
    metaDescription:
      "Chatbot que responde visitantes do seu site ou landing page na hora, qualifica leads e manda pro seu WhatsApp. Atendimento automático 24h para negócios no Rio de Janeiro.",
