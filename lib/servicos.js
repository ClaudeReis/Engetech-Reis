...
export const SERVICOS = [
  {
    ...
    keyword: "criar landing page profissional",
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Quanto tempo leva?", a: "Depende do tamanho do projeto. Fechado o escopo no briefing, a gente te passa um prazo real antes de começar." },
    ],
